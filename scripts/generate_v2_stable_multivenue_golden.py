...
CASES: tuple[tuple[str, str, Canonicalizer], ...] = (
    ...
    ("binance_usdm_rest_bar.json", "binance-usdm-rest-bar.bin", canonicalize_binance_usdm_rest_bar),
    ...
    ("binance_spot_rest_bar.json", "binance-spot-rest-bar.bin", canonicalize_binance_usdm_rest_bar),
